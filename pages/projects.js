        ...
        <article className='container flex flex-col gap-6 mt-40 mx-auto text-center'>
            ...
            <div className='grid grid-cols-2'>
                <div className='flex flex-col gap-4 px-12 text-left justify-center'>
                    ...
                    <p>
                        Problem: Slow information flow. Laser cutting company
                        was using email to transfer files and information about
                        orders. Managment had no way of getting fast information
                        about order status and had to relay on slow email
                        communication or check status in person which reduced
                        management efficiency. Operations team had unnecessary
                        workload which reduced it’s maximum output.
                    </p>
                    <p>
                        Solution: One-stop web application Order Managment
                        System. CRUD application with filestorage. Built with
                        Next.js framework, Redux state management, Firebase
                        authetication and storage, MongoDB database.
                    </p>
